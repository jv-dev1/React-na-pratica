    ...
    <div className="max-w-[1200px] mx-auto flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        <div className="flex flex-col items-end gap-0.5">
          <span className="text-sm font-medium">João Macedo</span>
          <span className="text-xs text-zinc-400">itsjoaovreis@gmail.com</span>
        </div>
        <img
          src="https://avatars.githubusercontent.com/u/80177229?s=400&u=6a05740cca1bf9b60e9b950e7ec4f09587740a65&v=4"
